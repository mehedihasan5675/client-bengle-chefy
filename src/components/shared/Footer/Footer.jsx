...
const Footer = () => {
    return (
        <div className=''>
            <footer className="footer pt-5  px-20 py-4  bg-black  ">
...
<footer className="footer items-center p-4 text-center bg-neutral text-neutral-content">
  <div className="items-center w-6/12 mx-auto justify-center text-center  grid-flow-col">
